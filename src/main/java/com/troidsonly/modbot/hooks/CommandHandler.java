 ...
 *   org.lizardirc.beancounter.hooks.CommandHandler
...
public interface CommandHandler {
     ...
     */
    Set<String> getSubCommands(GuildMessageReceivedEvent event, List<String> commands);

    void handleCommand(GuildMessageReceivedEvent event, List<String> commands, String remainder);
}
