...
public class FilterListener extends ListenerAdapter {
    ...
    public FilterListener(AccessControl acl, LogListener logger, PersistenceWrapper<?> wrapper, MuteListener muteListener, ExecutorService executorService, String fantasyString) {
        this.acl = acl;
        this.logger = logger;
