...
public class FilterListener extends ListenerAdapter {
    ...
    private final UserManagementListener userManagementListener;
    ...
    public FilterListener(AccessControl acl, LogListener logger, PersistenceWrapper<?> wrapper, UserManagementListener userManagementListener, ExecutorService executorService, String fantasyString) {
        this.acl = acl;
        this.logger = logger;
    ...
    UserManagementListener getUserManagementListener() {
