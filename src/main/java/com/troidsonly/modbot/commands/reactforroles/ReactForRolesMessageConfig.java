...
class ReactForRolesMessageConfig {
     ...
     * object.<p>
     *
     * The rendered message includes the full message text, as well as an explanation of what the message is and how
     * it works, as well as what emotes grant/revoke what roles.
     *
     * @param guild The {@link Guild} object representing the Discord server. This will be used to resolve role IDs
     * to role names and emote IDs to emotes.
     * @return The rendered message for display on Discord. Will never be empty or null.
     */
    public String renderMessage(Guild guild) {
        StringBuilder sb = new StringBuilder(messageText + INSTRUCTIONAL_TEXT);
