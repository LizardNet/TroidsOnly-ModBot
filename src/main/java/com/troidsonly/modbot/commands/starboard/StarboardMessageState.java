 ...
 * {@link #of(String, String, String)} method to get fresh instances. This is to allow JSON serialization to work
 * correctly.
 */
class StarboardMessageState {
     ...
     */
    public static StarboardMessageState of(String starboardChannelId, String starboardMessageId, String emoteId) {
