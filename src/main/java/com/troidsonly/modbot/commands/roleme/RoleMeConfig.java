...
class RoleMeConfig {
    ...
    private Set<String> welcomeMessages;
    ...
    public static RoleMeConfig ofEmpty() {
        ...
        emptyConfig.welcomeChannel = null;
        emptyConfig.welcomeMessages = Collections.emptySet();
     ...
     *
     * @param roleMeChannel Sets the roleme channel to the given Discord Channel ID, or null to disable
     */
     ...
     *
     * @param welcomeChannel The Discord Channel ID of the channel to send welcome messages to, or null to disable this
     * feature
     */
    ...
    /**
     * @return A set of strings representing welcome messages to be sent to the welcome channel when a user "roles-up".
     * These are format strings where the first parameter ({@code %1$s}) is a mention of the user being welcomed.  If
     * the set is empty, disable the feature; if the set contains more than one string, select one at random.  This
     * method may not return null.
     */
    public Set<String> getWelcomeMessages() {
     ...
     * set to the empty set, disable the feature; if the set contains more than one string, one will be selected at
     * random.  This may not be set to null.
     *
     * @param welcomeMessages The set of strings representing welcome messages.  May not be null.
     */
    public void setWelcomeMessages(Set<String> welcomeMessages) {
